...
public class MainPanel extends JPanel {
    ...
    public List<Passenger> filterResult(ArrayList<Passenger> passangerData) {
        return passangerData.stream().filter(passenger -> passenger.passengerInRange(this.valuesOfText[0], this.valuesOfText[1])).filter(passenger
        ...
        //return passangerData.stream().filter(passenger -> passenger.passengerInRange(this.valuesOfText[0],
        //        this.valuesOfText[1])).filter(passenger -> passenger.containsName(this.valuesOfText[2])).filter(passenger
        //        -> passenger.sibSPMatch(this.valuesOfText[3])).collect(Collectors.toList());
    }
